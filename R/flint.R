...
#' 300 test kits to randomly selected Flint homes.  The residents sampled their water and returned
#' it to the lab for testing.
#' The kits comprised of three bottles (1L, 500 mL and 250 mL) and an
#' instruction sheet for sampling tap water.
#' 
#' Each home was instructed to sample water at first draw (after the tap was
#' unused for 6 hours), after running for another 45 seconds, and after another 2 minutes.
#'
