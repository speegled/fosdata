...
#'
#' Cases and deaths due to COVID-19 by US state and date, due to The New York Times. Downloaded on July 29, 2020
#'
#' @format A data frame with 8154 observations of 5 variables.
#' \describe{
