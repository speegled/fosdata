...
#'   \item{ldaps_r_hmin}{LDAPS model forecast of next-day minimum relative humidity (percent): 19.8 to 98.5}
#'   \item{ldaps_r_hmax}{LDAPS model forecast of next-day maximum relative humidity (percent): 58.9 to 100}
...
#'   \item{ldaps_cc1}{LDAPS model forecast of next-day 1st 6-hour split average cloud cover (0-5 h) (percent): 0 to 0.97}
#'   \item{ldaps_cc2}{LDAPS model forecast of next-day 2nd 6-hour split average cloud cover (6-11 h) (percent): 0 to 0.97}
#'   \item{ldaps_cc3}{LDAPS model forecast of next-day 3rd 6-hour split average cloud cover (12-17 h) (percent): 0 to 0.98}
#'   \item{ldaps_tmax_lapse}{LDAPS model forecast of next-day maximum air temperature applied lapse rate: 17.6 to 38.5}
#'   \item{ldaps_tmin_lapse}{LDAPS model forecast of next-day minimum air temperature applied lapse rate: 14.3 to 29.6}
#'   \item{ldaps_ws}{LDAPS model forecast of next-day average wind speed (m/s): 2.9 to 21.9}
#'   \item{ldaps_lh}{LDAPS model forecast of next-day average latent heat flux (W/m2): -13.6 to 213.4}
...
#'   \item{ldaps_cc2}{LDAPS model forecast of next-day 2nd 6-hour split average cloud cover (6-11 h) (percent): 0 to 0.97}
#'   \item{ldaps_cc3}{LDAPS model forecast of next-day 3rd 6-hour split average cloud cover (12-17 h) (percent): 0 to 0.98}
#'   \item{ldaps_cc4}{LDAPS model forecast of next-day 4th 6-hour split average cloud cover (18-23 h) (percent): 0 to 0.97}
#'   \item{ldaps_ppt1}{LDAPS model forecast of next-day 1st 6-hour split average precipitation (0-5 h) (percent): 0 to 23.7}
#'   \item{ldaps_ppt2}{LDAPS model forecast of next-day 2nd 6-hour split average precipitation (6-11 h) (percent): 0 to 21.6}
#'   \item{ldaps_ppt3}{LDAPS model forecast of next-day 3rd 6-hour split average precipitation (12-17 h) (percent): 0 to 15.8}
#'   \item{ldaps_ppt4}{LDAPS model forecast of next-day 4th 6-hour split average precipitation (18-23 h) (percent): 0 to 16.7}
